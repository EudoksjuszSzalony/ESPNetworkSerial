...
## 3. Flash the BasicMonitor example over USB once
...
Set your Wi-Fi SSID/password and optionally change the OTA hostname.
...
## 4. Select the ESP32 network port
...
Port `3233` is assumed unless an explicit `host:port` is supplied.
